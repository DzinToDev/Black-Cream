  ...
  return (
    <div
      ...
      onMouseLeave={() => {
        ...
        setActiveIndex(index); // preserve the last hovered card
      }}
      className={`w-[32%] h-fit rounded-lg p-4 transition-all duration-300 cursor-pointer
        ${isActive ? "opacity-100" : "opacity-40"} bg-white text-black`}
    >
      <img
      ...
      <div className="w-full">
        <div className="flex justify-between">
          <p className="text-xs mt-4 mb-2 font-FragmentMono bg-black text-white">
            $ 79.00 USD
          </p>
