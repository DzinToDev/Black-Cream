  ...
  return (
    <div className="w-full min-h-screen bg-[#090A09] flex items-center justify-center px-22 py-16 gap-16">
      ...
      <div className="w-1/3 flex flex-col justify-start text-white ">
        <AnimatedText text="FAQ" className="font-FragmentMono text-xs" />
      ...
      <div className="w-1/3 space-y-3 ">
        {faqs.map((item, index) => (
          <div
            ...
            key={index}
            className="bg-[#151515] shadow-md rounded-xs overflow-hidden transition-all duration-400 pt-4 cursor-pointer "
          >
            <button className="w-full h-full flex justify-between items-center px-4 text-center cursor-pointer ">
